<%@ Page Title="Physio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PhysioView.aspx.cs" Inherits="Tunierverwaltung.PhysioView" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <div>
            <h1>Physiotherapeuten</h1>
            <asp:GridView ID="GridViewPhysio" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewPhysio_RowDataBound" ShowFooter="true" ShowHeaderWhenEmpty="true"
                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                CellPadding="3" DataKeyNames="PhysioID">
                <FooterStyle BackColor="White" ForeColor="#000066" />
                <Columns>
                    <asp:BoundField DataField="PhysioID" HeaderText="Id" InsertVisible="False" ReadOnly="True"
                        SortExpression="Id" />
