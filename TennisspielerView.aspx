...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <div>
               <h1> Tennisspieler </h1>
            <asp:GridView ID="GridViewTennisspieler" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewTennisspieler_RowDataBound" ShowFooter="true" ShowHeaderWhenEmpty="true"
                BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px"
                CellPadding="3" DataKeyNames="TennisspielerID">
                <FooterStyle BackColor="White" ForeColor="#000066" />
                <Columns>
                    <asp:BoundField DataField="TennisspielerID" HeaderText="Id" InsertVisible="False" ReadOnly="True"
                        SortExpression="Id" />
                    ...
                    <asp:TemplateField HeaderText="Hand" SortExpression="Hand">    
                        <FooterTemplate>
                            <asp:DropDownList ID="ddlHand" runat="server" >
                                <asp:ListItem Text="Links" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Rechts" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Beide" Value="2"></asp:ListItem>
                            </asp:DropDownList>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlHand" runat="server" OnTextChanged="DropDownList_TextChanged" >
                                <asp:ListItem Text="Links" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Rechts" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Beide" Value="2"></asp:ListItem>
                            </asp:DropDownList>                        
