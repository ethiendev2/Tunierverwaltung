...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <div>
            <h1>Materialwart</h1>
            <asp:GridView ID="GridViewMaterialwart" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewMaterialwart_RowDataBound" ShowFooter="true" ShowHeaderWhenEmpty="true"
