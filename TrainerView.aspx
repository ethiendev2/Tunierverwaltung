...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        ...
        <div>
            <h1> Trainer </h1>
            <asp:GridView ID="GridViewTrainer" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewTrainer_RowDataBound" ShowFooter="true" ShowHeaderWhenEmpty="true"
